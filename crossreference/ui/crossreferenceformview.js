 ...
 */
export default class CrossreferenceFormView extends View {
	/**
	 ...
	 */
	set reference( ref ) {
		this.urlInputView.inputView.element.value = ref.trim();
	}
	...
	_createUrlInput(className) {
		...
		this._urlInputViewInfoTip = t( 'Escribe texto a citar.' );

		labeledInput.label = t( 'Cita' );
		labeledInput.infoText = this._urlInputViewInfoDefault;
		inputView.placeholder = 'MK Room: Colección “Grandes Maestros del Jazz”. 2008. The Marketing Room S.A. 2008. Ref.: 00111';
